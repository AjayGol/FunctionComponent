                ...
                <View style={[{left: 0, right: 0, top: 0, bottom: 0, marginBottom: 27}]}>
                    <TouchableOpacity onPress={onSearchButton} style={{marginHorizontal: 20, flexDirection: 'row', alignItems: 'center',
                        ...
                        <View style={{flex: 1, flexDirection: 'row'}}>
                            <View style={{flex: 0.4}}/>
                            <Text style={[textBold]}>
                                {strLocale("wallet.Bitcoin")}
                            </Text>
                            <Text style={[textDescription, {marginLeft: 5}]}>
                                {strLocale("wallet.BTC")}
                            </Text>
                            <View style={{flex: 1}}/>
                        </View>
                    ...
                    <View style={outerTextView}>
                        ...
                        <View>
                            ...
                            <Text
                                style={importantText}>{"Please check your email to confirm the withdraw after submission.\n" +
                            "The minimum withdraw amount is 0.0005BTC."}</Text>
                        </View>
                    </View>
                </View>
...
export default connect(mapStateToProps, {})(tryWidthdrawal);
