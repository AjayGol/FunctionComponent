...
const openOrderRow = (props) => {
    ...
    const {data} = props;
    const {type, title, date, amount, filled, price, buttonTitle, transitionList, fees} = data;
        ...
        <View style={{
            ...
            <View style={{flexDirection: 'row'}}>
                <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                    <View style={{ backgroundColor: type === 'Deposit' && '#6EBFA7' || '#FA7E7E', borderRadius: 10, minWidth: 40}}>
            ...
            <View style={{flexDirection: 'row'}}>
                <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', marginTop: 13}}>
                    <Text style={[amountText, {color: '#010522'}]}>{transitionList}</Text>
                    <View style={{flex: 1}}/>
                </View>
            ...
            <View style={{flexDirection: 'row', marginBottom: 6}}>
                ...
                <View style={{flex: 1, flexDirection: 'row-reverse', alignItems: 'center', marginTop: 13}}>
                    <Text style={[amountText, {color: '#010522', marginLeft: 9, marginRight: 15}]}>{fees}</Text>
                    <Text style={[amountText, {color: '#010522'}]}>{"Fee"}</Text>
                    <View style={{flex: 1}}/>
                </View>
            </View>
